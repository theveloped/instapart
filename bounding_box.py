...
def get_boundingbox_dimensions(shape, tol=1e-6, use_mesh=True):
    """ return the bounding box of the TopoDS_Shape `shape`
    Parameters
    ----------
    shape : TopoDS_Shape or a subclass such as TopoDS_Face
    ...
    xmin, ymin, zmin, xmax, ymax, zmax, width, height, length = get_boundingbox(shape, tol=tol, use_mesh=use_mesh)
